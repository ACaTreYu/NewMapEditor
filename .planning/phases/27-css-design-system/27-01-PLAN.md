...
IMPORTANT: Before writing this section, read `src/styles/win98-variables.css` and catalog every semantic alias defined in its "TIER 2: SEMANTIC ALIASES" section. The complete list from that file (as of planning time) is:

Existing semantic variables in win98-variables.css (30 total):
  --surface, --surface-light,
  --text-primary, --text-secondary, --text-tertiary, --text-disabled,
  --bg-primary, --bg-secondary, --bg-tertiary, --bg-hover, --bg-active, --bg-window,
  --border-default, --border-subtle, --border-light, --border-dark,
...
Every one of these MUST appear in the new variables.css. Additionally, new semantic tokens may be added as needed.

New mappings (preserving all 30 existing + adding new tokens):
- Surface: --surface (neutral-0), --surface-secondary (neutral-50) [NEW], --surface-light (neutral-100) [EXISTING]
...
- Border: --border-default (neutral-300), --border-subtle (neutral-200), --border-light (neutral-100), --border-dark (neutral-700), --border-emphasis (neutral-500) [NEW]
