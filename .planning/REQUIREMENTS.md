...
- [ ] **VIEW-01**: Tile animations render correctly at all zoom levels (0.25x to 4x), not just at extreme zoom-out
...
- [ ] **PERF-01**: Rendering pipeline verified — no unnecessary redraws or lag at normal zoom levels
